...
TERMINAL_REWARDS_TO_STATUSES = {
    ...
    TwoPlayerGameEnv.CONNECTED: MCPNSNodeStatus.winning,
...
class MCPNS(Agent):
    ...
    def action(self, env, last_action=None):
        ...
        self._move_root_to_action(best_action, env.action_space)
        return best_action
    ...
    def _move_root_to_action(self, child, num_actions):
        ...
        self.root = self.root.children[child] if child in self.root.children else MCPNSNode(num_actions=num_actions)
        return child
