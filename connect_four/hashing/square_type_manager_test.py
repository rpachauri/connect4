...
class TestSquareTypeManager(unittest.TestCase):
    ...
    def test_create_all_groups_by_square_by_player_3x3_num_to_connect_3(self):
        all_groups = SquareTypeManager._create_all_groups(num_rows=3, num_cols=3, num_to_connect=3)
        got_all_groups_by_square_by_player = SquareTypeManager._create_all_groups_by_square_by_player(
            num_rows=3,
            num_cols=3,
